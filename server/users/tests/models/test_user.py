...
class UserModelManagerTest(TestCase):
    ...
    def test_object_manager_create_user_with_id(self):
        id = "1234567890"
        user = User.objects.create_user(
            id=id,
            email="ben_franklin@upenn.edu",
    ...
    def test_object_manager_create_superuser_with_id(self):
        id = "1234567890"
        user = User.objects.create_superuser(
            id=id,
            email="george_washington@gtown.edu",
...
class UserModelTest(TestCase):
    ...
    def test_duplicate_user_validations_email(self):
    ...
    def test_duplicate_user_validations_id(self):
        test_1 = User.objects.create(
            id="0",
            email="ben_franklin@upenn.edu",
            password="benfranklin123",
