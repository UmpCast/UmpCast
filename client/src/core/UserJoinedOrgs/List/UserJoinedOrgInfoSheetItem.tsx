...
export interface UserJoinedOrgInfoSheetItemProps extends IPressableProps {
    title: string
    icon: React.ReactNode
    children?: React.ReactNode
}

export default function UserJoinedOrgInfoSheetItem({
    title,
    icon,
    children,
    ...rest
}: UserJoinedOrgInfoSheetItemProps) {
    return (
        <Pressable
